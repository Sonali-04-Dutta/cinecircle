...
const Chat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white p-4 md:p-8 flex flex-col">
      <div className="max-w-4xl mx-auto w-full flex-1 flex flex-col bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-800/50 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
          ...
          {isTyping && (
            <div className="flex justify-start">
              <div className="bg-gray-700 text-gray-400 px-4 py-2 rounded-2xl rounded-bl-none text-sm italic animate-pulse">
                Typing...
              </div>
            </div>
          )}
        ...
        <div className="p-4 bg-gray-900 border-t border-gray-700">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 bg-gray-800 text-white border border-gray-600 rounded-full px-5 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder-gray-500"
            />
            <button 
              onClick={sendMessage} 
              disabled={!text.trim()}
